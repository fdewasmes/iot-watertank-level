...
// FDE : disabled this as it was blocking the main loop.
// I don't know what is the actual cause as I don't know
// precisely to what is linked the interrupt pin.
/*  if (!debugging) {
#ifdef SIGFOX_SPI
  ...
  for (i = 0; i < timeout/10; i++)
  {
    if (digitalRead(interrupt_pin) == 0) {
      ...
      // FDE avoid blinking LED to save power
