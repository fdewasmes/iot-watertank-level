...
// However, it really lowers the power consumption by a factor of 20 in low power mode (0.03mA vs 0.6mA)
  ...
  {
    // FDE : commented out to conform to this thread : https://forum.arduino.cc/index.php?topic=499101.0
    // Don't have any amperemeter so can't tell if this actually works.
  //   pinMode( ul, INPUT ) ;
  }
#endif
